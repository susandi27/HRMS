...
<main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-dashboard"></i> ဌာန</h1>
        <p>ဌာနများကို့ ထည့်ရန်။</p>
      </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tile-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                    <input type="text" placeholder="ဌာနအမည်အပြည့်စုံထည့်ရန်" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}">
                    @error('name')
